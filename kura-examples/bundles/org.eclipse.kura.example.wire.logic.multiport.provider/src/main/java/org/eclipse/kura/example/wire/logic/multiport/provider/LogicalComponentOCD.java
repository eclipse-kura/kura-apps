...
public @interface LogicalComponentOCD {
        ...
        @AttributeDefinition(//
                        ...
                        required = true, //
                        options = { @Option(label = "AND", value = "AND"), @Option(label = "OR", value = "OR"),
                                        @Option(label = "NOR", value = "NOR"), @Option(label = "NAND", value = "NAND"),
                                        @Option(label = "XOR", value = "XOR"), @Option(label = "NOT", value = "NOT") })
