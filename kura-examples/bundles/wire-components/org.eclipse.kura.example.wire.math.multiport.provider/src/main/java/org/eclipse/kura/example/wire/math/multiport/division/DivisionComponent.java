...
@Component(immediate = true, //
        ...
        enabled = true, //
        name = "org.eclipse.kura.example.wire.math.multiport.division.DivisionComponent", //
        property = { //
...
@Designate(ocd = DivisionComponentOCD.class, factory = true)
public class DivisionComponent extends AbstractDualportMathComponent {
    ...
    @Activate
    public void activate(ComponentContext context, DivisionComponentOCD ocd) {
        super.activate(new ParserOCD(ocd).toPropertiesMap(), context);
    }

    @Modified
    public void updated(ComponentContext context, DivisionComponentOCD ocd) {
