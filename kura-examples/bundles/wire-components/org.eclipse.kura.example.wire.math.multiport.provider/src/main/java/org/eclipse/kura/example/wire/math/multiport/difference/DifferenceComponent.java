...
@Component(immediate = true, //
        ...
        enabled = true, //
        name = "org.eclipse.kura.example.wire.math.multiport.difference.DifferenceComponent", //
        property = { //
...
@Designate(ocd = DifferenceComponentOCD.class, factory = true)
public class DifferenceComponent extends AbstractDualportMathComponent {
    ...
    @Activate
    public void activate(ComponentContext context, DifferenceComponentOCD ocd) {
        super.activate(new ParserOCD(ocd).toPropertiesMap(), context);
    }

    @Modified
    public void updated(ComponentContext context, DifferenceComponentOCD ocd) {
