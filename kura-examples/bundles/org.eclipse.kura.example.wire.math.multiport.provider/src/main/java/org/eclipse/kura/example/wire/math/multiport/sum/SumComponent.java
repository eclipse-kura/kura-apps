...
@Component(immediate = true, //
        ...
        enabled = true, //
        name = "org.eclipse.kura.example.wire.math.multiport.sum.SumComponent", //
        property = { //
...
@Designate(ocd = SumComponentOCD.class, factory = true)
public class SumComponent extends AbstractDualportMathComponent {
    ...
    @Activate
    public void activate(ComponentContext context, SumComponentOCD ocd) {
        super.activate(new ParserOCD(ocd).toPropertiesMap(), context);
    }

    @Modified
    public void updated(ComponentContext context, SumComponentOCD ocd) {
