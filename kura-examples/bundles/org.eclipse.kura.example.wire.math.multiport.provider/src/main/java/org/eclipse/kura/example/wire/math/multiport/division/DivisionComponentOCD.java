...
package org.eclipse.kura.example.wire.math.multiport.division;

import org.osgi.service.metatype.annotations.AttributeDefinition;
import org.osgi.service.metatype.annotations.ObjectClassDefinition;

/**
 * A wire component that performs the division of the values of two properties
 * contained in two envelopes received on different ports.
 */
@ObjectClassDefinition( //
        id = "org.eclipse.kura.example.wire.math.multiport.division.DivisionComponent", //
        name = "Division", //
        description = "A wire component that performs the division of the values of two properties contained in two envelopes received on different ports." //
)
public @interface DivisionComponentOCD {
