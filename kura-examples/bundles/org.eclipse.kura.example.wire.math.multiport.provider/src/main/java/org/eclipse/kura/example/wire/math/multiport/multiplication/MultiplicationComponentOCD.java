...
/**
 * A wire component that performs the multiplication of the values of two
 * properties
 * contained in two envelopes received on different ports.
 */
@ObjectClassDefinition( //
        id = "org.eclipse.kura.example.wire.math.multiport.multiplication.MultiplicationComponent", //
        name = "Multiplication", //
...
public @interface MultiplicationComponentOCD {
