 ...
 *  Eurotech
 *******************************************************************************/
package main.java.org.eclipse.kura.example.container.signature.validation;
...
@ObjectClassDefinition(name = "Dummy Container Signature Validation Service", //
...
public @interface DummyContainerSignatureValidationServiceOCD {
        ...
        @AttributeDefinition(name = "Set signature validation outcome", //
        ...
        String set_signature_validation_outcome() default "";
}
